...
Elm.App.make = function (_elm) {
   ...
   var textField = function (result) {
      return $Bootstrap$Html.row_(_L.fromArray([A4($Bootstrap$Html.colMd_,
                                               ...
                                               8,
                                               8,
                                               _L.fromArray([$Bootstrap$Html.row_(_L.fromArray([A4($Bootstrap$Html.colMd_,
                                               12,
                                               12,
                                               12,
                                               _L.fromArray([A2($Html.textarea,
                                                            _L.fromArray([$Html$Attributes.style(myStyle)
                                                                         ,$Html$Attributes.value(sample)
                                                                         ,A3($Html$Events.on,
                                                                         "input",
                                                            ...
                                                            _L.fromArray([A2($Html.div,
                                                            _L.fromArray([$Html$Attributes.style(fontStyle)]),
                                                            _L.fromArray([$Html.text("↓")]))]))
                                                            ,A2($Html.textarea,
                                                            _L.fromArray([$Html$Attributes.style(myStyle)
                                                                         ,$Html$Attributes.value(result)]),
                                                            _L.fromArray([]))]))]))]))
                                               ,A4($Bootstrap$Html.colMd_,
                                               2,
                                               2,
   ...
   var view = function (result) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([$Bootstrap$Html.container_(_L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("page-header")]),
                   _L.fromArray([A2($Html.h1,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("svg -> elm-svg Function")]))]))]))
                   ,textField(result)]));
   };
   var update = F2(function (action,
   state) {
      return svgToElm(action);
   });
...
Elm.SvgParser = Elm.SvgParser || {};
Elm.SvgParser.make = function (_elm) {
   "use strict";
   _elm.SvgParser = _elm.SvgParser || {};
   if (_elm.SvgParser.values)
   return _elm.SvgParser.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var isSpace = function (c) {
      return function () {
         var target = $String.fromChar(c);
         return A2($Regex.contains,
         $Regex.regex("[\\s\\n\\t\\f\\v]"),
         target);
      }();
   };
   var spaces = $Parser.many($Parser.satisfy(function (s) {
      return isSpace(s);
   }));
   var endTag = function (str) {
      return A2($Parser._op["<*"],
      A2($Parser._op["*>"],
      $Parser.token("</"),
      $Parser.token(str)),
   ...
   var charTest = F2(function (c,
   s) {
      return function () {
         var f = F2(function (target,
         a) {
            return !_U.eq(a,target);
         });
         return A2($List.all,
         f(c),
         $String.toList(s));
   ...
   var noneOf = function (list) {
      return $Parser.satisfy(function (c) {
         return A2(charTest,c,list);
      });
   };
   var filterJoin = F2(function (s,
   list) {
      return function () {
         var toNomal = function (jstr) {
            return function () {
               switch (jstr.ctor)
   ...
   var bodyText = A2($Parser.andThen,
   $Parser.some(noneOf("><")),
   function (x) {
      return function () {
   ...
   var generateAttribute = function (ls) {
      return function () {
         var isIgnoreCase = function (name) {
            return _U.eq(name,
            "xmlns") || _U.eq(name,
            "xmlnsXlink");
         };
         var f = function (x) {
            return function () {
               ...
               {case "SVGAttr":
                  switch (x._0.ctor)
                    {case "_Tuple2":
                       return isIgnoreCase(x._0._0) ? $Maybe.Nothing : $Maybe.Just(A2($Basics._op["++"],
                         x._0._0,
                         A2($Basics._op["++"],
                         " ",
                         A2($Basics._op["++"],
   ...
   var upparName = F2(function (frontPart,
   backPart) {
      return function () {
         var up = function () {
            var _v8 = $List.head(backPart);
            switch (_v8.ctor)
            {case "Just":
               return $Char.toUpper(_v8._0);
               case "Nothing":
               return _U.chr(" ");}
            _U.badCase($moduleName,
   ...
   var attriName = A2($Parser.andThen,
   $Parser.many(noneOf("-:= />")),
   function (frontPart) {
      return A2($Parser.andThen,
      A2($Parser._op["<|>"],
      $Parser.symbol(_U.chr(":")),
      $Parser.symbol(_U.chr("-"))),
      function (key) {
         ...
         $Parser.many(noneOf(":= />")),
         function (backPart) {
            return $Parser.succeed(A2(upparName,
            frontPart,
            backPart));
         });
      });
   });
   var jenerateElementTag = F3(function (name,
   attributePart,
   elements) {
      return A2($Basics._op["++"],
      name,
      ...
      " [ ",
      A2($Basics._op["++"],
      filterJoin(" , ")(generateAttribute(attributePart)),
      A2($Basics._op["++"],
      " ]",
      A2($Basics._op["++"],
      " [ ",
      A2($Basics._op["++"],
      A2(filterJoin," , ",elements),
      " ]"))))));
   });
   var jenerateOneLineTag = F2(function (name,
   attributePart) {
      return A2($Basics._op["++"],
      name,
      A2($Basics._op["++"],
   ...
   var SVGAttr = function (a) {
      return {ctor: "SVGAttr"
             ,_0: a};
   };
   var attribute = A2($Parser.andThen,
   A2($Parser._op["<|>"],
   $Parser.many(noneOf(":-= />")),
   attriName),
   function (name$) {
      return function () {
         var name = $String.fromList(name$);
         return A2($Parser.andThen,
         $Parser.token("=\""),
         function (_v14) {
            return function () {
               ...
               function (value) {
                  ...
                  function (_v16) {
                     return function () {
                        ...
                        function (_v18) {
                           return function () {
                              return $Parser.succeed(SVGAttr({ctor: "_Tuple2"
                                                             ,_0: name
                                                             ,_1: $String.fromList(value)}));
                           }();
                        });
                     }();
                  });
                           ...
                           function (attributePart) {
                              ...
                              function (_v26) {
                                 return function () {
                                    ...
                                    $Parser.token("/>")),
                                    function (close) {
                                       return _U.eq($String.length(close),
                                       2) ? $Parser.succeed($Maybe.Just(A2(jenerateOneLineTag,
                                       name,
                                       attributePart))) : A2($Parser.andThen,
                                       $Parser.many(elementBody),
                                       function (elements) {
                                          return A2($Parser.andThen,
                                          spaces,
                                          function (_v28) {
                                             return function () {
                                                ...
                                                function (_v30) {
                                                   return function () {
                                                      ...
                                                      function (_v32) {
                                                         return function () {
                                                            return $Parser.succeed($Maybe.Just(A3(jenerateElementTag,
                                                            name,
                                                            attributePart,
                                                            elements)));
                                                         }();
   ...
   var elementBody = A2($Parser._op["<|>"],
   A2($Parser._op["*>"],
   spaces,
   $Parser.recursively(function (_v34) {
      return function () {
         switch (_v34.ctor)
   ...
   bodyText);
   var svgToElmParser = A2($Parser.andThen,
   spaces,
   function (_v36) {
      return function () {
         return A2($Parser.andThen,
               ...
               return function () {
                  ...
                  function (tags) {
                     ...
                     function (_v40) {
                        return function () {
                           return function () {
                              var all = A2(filterJoin,
                              " , ",
                              tags);
                              return $Parser.succeed(all);
                           }();
                        }();
                     });
                  });
   ...
   _elm.SvgParser.values = {_op: _op
                           ,svgToElmParser: svgToElmParser};
   return _elm.SvgParser.values;
};
Elm.Task = Elm.Task || {};
